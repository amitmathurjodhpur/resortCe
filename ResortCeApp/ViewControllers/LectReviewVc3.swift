...
import UIKit
class CellQuestion3: UITableViewCell
{
...
class LectReviewVc3: UIViewController,UIWebViewDelegate{
    ...
    @IBOutlet weak var LblHeadingTitle: UILabel!
        ...
        func postCourseContent() {
            ...
            DataManager.postAPIWithParameters(urlString: API.course_content_listing, jsonString: Request.oneCourseId(UserDefaults.standard.value(forKey: "auth_key") as! String,  getReview3) as [String : AnyObject], success: {
                sucess in
                ...
                self.LblHeadingTitle.text = (QuestionsAnswer["chapter_name"] as! String) + " Part 3"
        ...
        @IBAction func ActnSubmitBtn(_ sender: Any)
        {
            ...
            if selectedSection0 == 0 && selectedSection1 == 1
            {
                ...
                let vc = storyboard?.instantiateViewController(withIdentifier: "LectReviewVc4") as? LectReviewVc4
    ...
    extension LectReviewVc3 : UITableViewDelegate,UITableViewDataSource
    {
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
        {
            ...
            let cell : CellQuestion3 = (tableView.dequeueReusableCell(withIdentifier: "CellQuestion3") as? CellQuestion3)!
