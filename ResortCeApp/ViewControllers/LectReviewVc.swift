...
class LectReviewVc : UIViewController ,UIWebViewDelegate{
    ...
    {
        DataManager.postAPIWithParameters(urlString: API.completedCourse, jsonString: Request.oneCourseId(UserDefaults.standard.value(forKey: "auth_key") as! String, getReview) as [String : AnyObject], success: {
            sucess in
