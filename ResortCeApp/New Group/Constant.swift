...
public let newAPIURL                  = "http://52.15.160.147/resort-ce/admin/Apis/"
...
public struct API {
    ...
    public static let socialLogin             =           newAPIURL+"social_login"
    public static let course_listing           =          baseURL+"course_listing"
    public static let one_course_list           =         newAPIURL+"one_course_list"
    public static let course_add_to_favourite   =      newAPIURL+"course_add_to_favourite"
    public static let my_course_listing         =         baseURL+"my_course_listing"
    public static let course_in_progress_listing = newAPIURL+"course_in_progress_listing"
    public static let edituserprofiledetails   = newAPIURL+"edit_user_profile_details"
    public static let course_add_to_buy             =   newAPIURL+"course_add_to_buy"
    ...
    public static let TripListing       =      newAPIURL+"my_trip_listing"
    public static let CertificateReport      =      newAPIURL+"my_profile_data"
